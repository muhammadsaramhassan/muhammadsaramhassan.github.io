export default function About() {
	return (
		<div className="max-w-[900px] mx-auto px-6 py-12">
			<h1 className="text-3xl font-serif mb-8"><b>About me.</b></h1>
			<div className="flex flex-col md:flex-row items-start space-y-6 md:space-y-0 md:space-x-8">
				...
				<div>
					<p className="text-base mt-2 mb-4">
						Hi, I'm Muhammad Saram Hassan. I'm a Computer Science Undergrad at
						LUMS, Pakistan with a concentration in Machine Learning.
					</p>
					...
					<p className="text-base mt-4">
						You can find more about my research and projects on my blog and
						papers page. for a quick summary of my work, you can check out my
						resume [hyperlink]."
					</p>
				</div>
			</div>
