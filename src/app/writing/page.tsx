...
export const metadata: Metadata = {
  title: 'Writing',
  description: 'Short essays on interpretability, ML systems, and the scaffolding around them.',
}
        ...
        <section className="vol">
          <div className="container">
            <div className="vol-kicker">
              ...
              <span>Section § III · Notes from the workbench</span>
              <span className="sep">·</span>
              <span>2024—2026</span>
            </div>
            ...
            <p className="vol-sub">
              ...
              much of a plan. Subscribe if you want them in your inbox;
              otherwise, read in any order.
            </p>
