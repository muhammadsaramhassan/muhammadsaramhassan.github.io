      ...
      <main>
        <article>
          ...
          <div className="prose-post">
            ...
            >
              <Link href="/writing" style={{ color: 'var(--ink-mid)', borderBottom: '1px solid var(--rule)', paddingBottom: '2px' }}>
                ← writing
              </Link>
            ...
            >
              <Link
                href="/writing"
                style={{ color: 'var(--maroon)', borderBottom: '1px solid var(--maroon)', paddingBottom: '2px' }}
              >
                ← back to writing
              </Link>
              <a
